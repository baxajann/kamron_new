...
export default function NewOrderPage() {
  ...
  const [paymentType, setPaymentType] = useState("CASH") // CASH, TRANSFER, CREDIT
    ...
    <div className="max-w-4xl mx-auto pb-12 animate-fade-in">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Оформление новой продажи</p>
        </div>
      </div>
          ...
          <div className="space-y-3">
            ...
            {items.length === 0 && (
              <div className="text-center py-8 text-gray-500 border-2 border-dashed rounded-xl">
                Нет добавленных товаров. <button type="button" onClick={handleAddItem} className="text-blue-500 font-medium hover:underline">Добавить</button>
              </div>
            )}
          </div>
